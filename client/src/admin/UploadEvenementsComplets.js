...
import { createEvenementsComplets } from '../actions/evenementAR'
import './AdminStyle.css'

function UploadEvenementsComplets() {
    ...
    const handleSubmit = async(e) =>{
        e.preventDefault();
        EvenementCompletsARDispatch(createEvenementsComplets(listOfEvenements))
        console.log(listOfEvenements)
    }
    return (
        <div className='UploadEvenementComplets'>
            <form autoComplete='off' noValidate className='form' onSubmit={handleSubmit}>
                <Paper elevation={4} className='paper'>
                    <Typography variant='h6'><Box fontWeight={800}>Crée des évenements complets</Box></Typography>
...
export default UploadEvenementsComplets